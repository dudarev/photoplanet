...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.vote_prediction'
        db.add_column(u'photoplanet_photo', 'vote_prediction',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.vote_prediction'
        db.delete_column(u'photoplanet_photo', 'vote_prediction')
